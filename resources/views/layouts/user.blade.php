...
<head>
    ...
    <title>@yield('title', 'Aadya Construction – Transport and Logistics')</title>
    ...
    <style>
        ...
        :root {
            --pbmit-global-color: #4a0404;
            /* Deep Maroon */
            --pbmit-secondary-color: #800000;
            --pbmit-light-navy: #4a0404;
            /* Gold Accent */
            --pbmit-gold: #4a0404;
        ...
        .award-section-two .row {
            display: flex;
            flex-wrap: wrap;
        }

        .award-section-two .pbmit-right-col {
            display: flex;
            flex-direction: column;
        }

        .award-section-two .pbmit-award-wraper {
            flex: 1;
            display: flex;
            flex-direction: column;
        ...
        .bg-maroon {
            background: var(--pbmit-maroon-gradient) !important;
            color: white !important;
        }

        .bg-gold {
            background: var(--pbmit-gold-gradient) !important;

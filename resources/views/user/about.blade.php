...
@section('title', 'About Us - Adhya Construction')
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 ps-lg-5">
                    ...
                    <div class="mt-4 mb-4">
                        <p class="lead text-muted">{{ $history->description ?? 'Adhya Construction is a premier construction and logistics company delivering excellence for over a decade.' }}</p>
                        <p>We pride ourselves on our commitment to quality, safety, and innovation. Over the years, we have grown from a small local firm to a national player in the construction and transport logistics sector, serving industry leaders across India.</p>
                    </div>

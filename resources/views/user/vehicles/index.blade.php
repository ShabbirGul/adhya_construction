...
@section('title', 'Our Vehicles - Aadya Construction')
                    ...
                    <div class="sidebar">
                        <aside class="widget widget_categories p-4 border rounded">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{ route('user.vehicles') }}"
                                        class="{{ !request('category') ? 'pbmit-color-global font-weight-bold' : '' }}">All
                                        Vehicles</a></li>
                                ...
                                <article class="pbmit-service-style-2 p-0 border rounded shadow-sm h-100 overflow-hidden">
                                    <div class="pbminfotech-post-item">
                                        ...
                                        <div class="pbminfotech-box-content p-3">
                                            <div class="pbmit-serv-cat pbmit-color-global font-weight-bold">

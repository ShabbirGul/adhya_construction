...
@section('title', 'Contact Us - Aadya Construction')
...
@section('content')
                        ...
                        <form class="contact-form" action="{{ route('user.contact.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <input type="text" name="name" class="form-control py-3" placeholder="Your Name"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
    ...
    <div class="section-xl p-0">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3430.729050064562!2d76.688562375543!3d30.710526074596356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fee9384742d41%3A0xf639726279f6e52c!2sAadya%20Construction!5e0!3m2!1sen!2sin!4v1709810000000!5m2!1sen!2sin"

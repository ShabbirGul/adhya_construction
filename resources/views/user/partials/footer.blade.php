                ...
                <div class="pbmit-footer-widget-col-1 col-md-3">
                    <aside class="widget">
                        <div class="pbmit-footer-logo" style="max-width: 180px;">
                            <img src="{{ asset('assets/user/images/aadyalogo.png') }}" class="img-fluid"
                                alt="Aadya Construction" style="filter: brightness(0) invert(1); width: 100%;">
                        </div>
                    </aside>
                </div>
                    ...
                    <aside class="widget">
                        <div class="pbmit-contact-widget-lines text-white">
                            ...
                            <div class="pbmit-contact-widget-line pbmit-base-icon-email"><a
                                    href="mailto:aadyaconstructionsequip@gmail.com"
                                    class="text-white">aadyaconstructionsequip@gmail.com</a></div>
                        </div>
                    </aside>
                </div>
                ...
                <div class="pbmit-footer-widget-col-4 col-md-3">
                    <aside class="widget widget_text">
                        ...
                        <ul class="menu mx-0 px-0" style="list-style: none;">
                            ...
                            <li><a href="{{ route('home') }}#global-presence" class="text-white-50 small">Global
                                    Presence</a></li>
                        </ul>
                    </aside>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pbmit-footer-copyright-text-area">
                            Copyright © {{ date('Y') }} <a href="#">Aadya Construction</a>, All Rights Reserved.
                        </div>
                    </div>
                </div>
            </div>

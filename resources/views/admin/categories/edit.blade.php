...
<a href="{{ route('admin.dashboard') }}" style="color: #64748b;">Admin</a> / <a href="{{ route('categories.index') }}"
    style="color: #64748b;">Categories</a> / <span>Edit</span>
@endsection
...
<div class="form-card" style="max-width: 800px; margin: 0 auto;">
    <div style="margin-bottom: 2rem; border-bottom: 1px solid #f1f5f9; padding-bottom: 1rem;">
        <h2 style="margin:0; font-size: 1.5rem; color: var(--dark); font-weight: 700;">Edit Category</h2>
        <p style="color: #64748b; margin: 0.5rem 0 0 0;">Update the core details and branding of your category.</p>
    </div>
    <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="description" rows="5" placeholder="Enter details..." required
        ...
        <div style="display: flex; gap: 1rem; margin-top: 3rem; border-top: 1px solid #f1f5f9; padding-top: 2rem;">
            <button type="submit" class="btn" style="padding: 0.875rem 2.5rem;">UPDATE CATEGORY</button>
